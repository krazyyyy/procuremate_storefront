...
const ProductItemViewNew = ({ notFound }: CusotmProps) => {
  ...
  useEffect(() => {
    if (data) {
      if (data.collection?.handle.includes('custom')) {
        setStep(2)
...
ProductItemViewNew.getLayout = (page: any) => {
...
export default ProductItemViewNew
