...
const Items = ({ items, region, cartId }: ItemsProps) => {
  ...
  return (
    <div className="p-10 border-b font-montserrat border-gray-200 gap-y-4 flex flex-col">
              ...
              <div className="flex flex-col justify-between flex-1">
                <div className="flex flex-col flex-1 text-small-regular">
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="text-base-regular sm:text-lg font-bold overflow-ellipsis overflow-hidden whitespace-nowrap mr-4">
                        <Link
