...
type InfiniteFullSetProductsType = {
  params: StoreGetProductsParams
}

const InfiniteFullSetProducts = ({ params }: InfiniteFullSetProductsType) => {
  const { cart } = useCart()
  ...
  return (
    <div className="flex-1 p-0 small:p-auto content-container">
...
export default InfiniteFullSetProducts
