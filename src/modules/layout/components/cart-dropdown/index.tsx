  ...
  return (
    <div className="h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Link href="/cart/details" passHref legacyBehavior>
        ...
        >
          <Popover.Panel
            static
            className="block w-screen absolute top-full -right-8 small:right-0 small:top-[calc(100%+1px)] bg-white border-x border-b border-gray-200 small:w-[382px] text-gray-900"
          >
